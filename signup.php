...
<html lang="en">
  ...
  <body>
    ...
    <div class="navigation">
      ...
      <a href="index.html" class="logo"><h1>Smart<span class="logo2">Trand</span></h1></a>
    ...
    <div class="container">
      <div class="login-form">
        <form action="signup-check.php" method="post">
          <h1>Регистрация</h1>
          <p>
            Пожалуйста заполните поля чтобы зарегистрироваться или
     	...
     	<input type="password" 
          ...
          <label for="psw">Повторите пароль</label>
          <input type="password" 
                 name="re_password" 
